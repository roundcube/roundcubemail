...
class MailFunc extends PHPUnit_Framework_TestCase
{
    public function setUp()
    {
        ...
        require_once (INSTALL_PATH . 'program' . PATH_SEPARATOR . 'steps' . PATH_SEPARATOR . 'mail' . PATH_SEPARATOR. 'func.inc');
    }

    /**
     * Helper method to create a HTML message part object
     */
    public function get_html_part($body = null)
    {
    ...
    public function test_html_xss2()
    {
        ...
        $washed = rcmail_html4inline(rcmail_print_body($part->body, $part, array('safe' => true)), array('container_id' => 'dabody', 'safe' => true));
    ...
    {
        // #1488850
        $html = '<p><a href="data:text/html,&lt;script&gt;alert(document.cookie)&lt;/script&gt;">Firefox</a><a href="vbscript:alert(document.cookie)">Internet Explorer</a></p>';
    ...
    public function test_mailto()
    {
        ...
        $mailto = '<a href="mailto:me@me.com" onclick="return rcmail.command(\'compose\', \'me@me.com?subject=this is the subject&amp;body=this is the body\', this)" rel="noreferrer">e-mail</a>';
     ...
     */
    public function test_resolve_base()
    {
     ...
     */
    public function test_rcmail_identity_select()
    {
        $identities = array(
            array(
                'name'        => 'Test',
     ...
     */
    public function test_rcmail_identity_select2()
    {
        $identities = array(
            array(
                'name'        => 'Test 1',
