...
roundcubemail-git: buildtools
	...
	(cd roundcubemail-git; rm -f .eslintrc.js .php-cs-fixer.dist.php phpstan.neon.dist docs/CODE_OF_CONDUCT.md docs/SOCIAL_WORK_GUIDELINES.md docs/RELEASE_MANAGEMENT.md)
