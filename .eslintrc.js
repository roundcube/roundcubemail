module.exports = {
    ...
    rules: {
        ...
        'no-return-assign': 'off', // (1 matches)
        ...
        'unicorn/prefer-dom-node-dataset': 'off', // (1 matches)
        ...
        'unicorn/no-new-array': 'off', // (1 matches)
        'no-debugger': 'off', // (1 matches)
        'no-whitespace-before-property': 'off', // (1 matches)
        'no-constant-condition': 'off', // (1 matches)
        'no-implied-eval': 'off', // (1 matches)
        'unicorn/no-document-cookie': 'off', // (1 matches)
        'unicorn/prefer-default-parameters': 'off', // (1 matches)
        'unicorn/prefer-negative-index': 'off', // (1 matches)
        'no-regex-spaces': 'off', // (1 matches)
    },
